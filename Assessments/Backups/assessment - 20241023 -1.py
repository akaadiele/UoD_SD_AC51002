...
def retrieveOperatingHours():
    try:
        with open(directoryPath + "/Operating_Hours_Log.txt", "r",encoding="UTF-8") as openedFile:
            fileContent = openedFile.read()
...
def updateOperatingHours(operatingHours,hoursWorked):
    ...
    with open(directoryPath + "/Operating_Hours_Log.txt", "w",encoding="UTF-8") as openedFile:
